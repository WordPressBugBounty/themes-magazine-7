...
function magazine_7_scripts() {
	...
	wp_enqueue_style('magazine-7-style', get_stylesheet_uri(),array(), wp_get_theme()->get( 'Version' ));
...
function magazine_7__admin_scripts($hook){
	...
	wp_enqueue_style('magazine-7-notice', get_template_directory_uri().'/assets/notice.css');
}
